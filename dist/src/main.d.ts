...
export declare const assertForallAsync: <A>(g: Gen<A>, prop: (a: A, p: P.Property) => Promise<boolean>, options?: Partial<{
    tests: number;
    maxShrinks: number;
    seed: number | undefined;
    expectFailure: boolean;
...
export declare const forallStringsAsync: <A>(g: Gen<A>, prop: (a: A, p: P.Property) => Promise<boolean>, options?: Partial<{
    tests: number;
    maxShrinks: number;
    seed: number | undefined;
    expectFailure: boolean;
