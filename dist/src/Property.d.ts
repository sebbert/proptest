...
export declare type Answer<A> = undefined | {
    value: A;
    exception?: any;
    log: any[][];
    fuel: number;
};
export declare function searchAsync<A>(g: Gen<A>, prop: (a: A, p: Property) => Promise<boolean>, options?: Partial<Options>): Promise<SearchResult<A>>;
...
export declare function searchAndThenAsync<R>(then: <A>(a: SearchResult<A>) => R): <A>(g: Gen<A>, prop: (a: A, p: Property) => Promise<boolean>, options?: Partial<Options>) => Promise<R>;
